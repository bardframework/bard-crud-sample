...
public abstract class ReadRestControllerAbstract<M extends SampleModelAbstract, C extends SampleCriteriaAbstract, S extends SampleServiceAbstract<M, C, Object, ?>> extends OperationRestControllerAbstract<M, C, Object, S> implements ReadRestController<M, C, S, String, SampleUser> {
