...
public abstract class SampleRepositoryQdslSqlAbstract<M extends BaseModel<I>, C extends BaseCriteria<I>, I> extends BaseRepositoryQdslSqlAbstract<M, C, I, SampleUser> implements SampleRepository<M, C, I> {
