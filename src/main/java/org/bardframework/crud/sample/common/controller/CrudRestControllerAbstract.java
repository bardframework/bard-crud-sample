...
public abstract class CrudRestControllerAbstract<M extends SampleModelAbstract, C extends SampleCriteriaAbstract, D, S extends SampleServiceAbstract<M, C, D, ?>> extends OperationRestControllerAbstract<M, C, D, S> implements ReadRestController<M, C, S, String, SampleUser>, WriteRestController<M, D, S, String, SampleUser> {
