...
public abstract class WriteRestControllerAbstract<M extends SampleModelAbstract, C extends SampleCriteriaAbstract, D, S extends SampleServiceAbstract<M, C, D, ?>> extends OperationRestControllerAbstract<M, C, D, S> implements WriteRestController<M, D, S, String, SampleUser> {
