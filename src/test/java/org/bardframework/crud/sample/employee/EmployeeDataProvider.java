...
import org.bardframework.crud.sample.common.SampleDataProviderServiceAbstract;
import org.bardframework.crud.sample.common.SampleUser;
import org.springframework.stereotype.Service;

@Service
public class EmployeeDataProvider extends SampleDataProviderServiceAbstract<EmployeeModel, EmployeeCriteria, EmployeeDto, EmployeeService, EmployeeRepository> {

    @Override
    public EmployeeDto getDto(SampleUser sampleUser) {
