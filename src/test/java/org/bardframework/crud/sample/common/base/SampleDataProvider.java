...
public abstract class SampleDataProvider<M extends BaseModel<I>, C extends BaseCriteria<I>, D, S extends BaseService<M, C, D, R, I, SampleUser>, R extends BaseRepository<M, C, I, SampleUser>, I> implements ServiceDataProvider<M, C, D, S, R, I, SampleUser> {

    private final S service;
    private final Class<C> criteriaClazz;

    protected SampleDataProvider(S service) {
